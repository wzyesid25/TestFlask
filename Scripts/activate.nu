...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\USUARIO\python\flask\sistemas\flask_env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\USUARIO\python\flask\sistemas\flask_env\Scripts\deactivate.nu'
